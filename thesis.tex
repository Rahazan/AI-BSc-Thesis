...
\begin{table}[h]
\begin{tabular}{ccccl}
\multicolumn{1}{l}{Diff 1} & \multicolumn{1}{l}{Diff 2} & \multicolumn{1}{l}{Diff 3} & \multicolumn{1}{l}{Diff 4} & \textless-- Classified as \\ \cline{1-4}
1                          & 7                          & 1                          & \multicolumn{1}{c|}{3}     & Diff 1                    \\
3                          & 7                          & 0                          & \multicolumn{1}{c|}{2}     & Diff 2                    \\
2                          & 4                          & 2                          & \multicolumn{1}{c|}{4}     & Diff 3                    \\
2                          & 2                          & 1                          & \multicolumn{1}{c|}{7}     & Diff 3                   
\end{tabular}
\end{table}
...
\begin{tabular}{ccccl}
\multicolumn{1}{l}{Diff 1} & \multicolumn{1}{l}{Diff 2} & \multicolumn{1}{l}{Diff 3} & \multicolumn{1}{l}{Diff 4} & \textless-- Classified as \\ \cline{1-4}
1                          & 5                          & 6                          & \multicolumn{1}{c|}{0}     & Diff 1                    \\
5                          & 3                          & 3                          & \multicolumn{1}{c|}{1}     & Diff 2                    \\
3                          & 1                          & 5                          & \multicolumn{1}{c|}{3}     & Diff 3                    \\
5                          & 0                          & 5                          & \multicolumn{1}{c|}{2}     & Diff 3                   
\end{tabular}
\end{table}
...
\begin{tabular}{ccccl}
\multicolumn{1}{l}{Diff 1} & \multicolumn{1}{l}{Diff 2} & \multicolumn{1}{l}{Diff 3} & \multicolumn{1}{l}{Diff 4} & \textless-- Classified as \\ \cline{1-4}
3                          & 4                          & 3                          & \multicolumn{1}{c|}{2}     & Diff 1                    \\
3                          & 5                          & 2                          & \multicolumn{1}{c|}{2}     & Diff 2                    \\
2                          & 3                          & 6                          & \multicolumn{1}{c|}{1}     & Diff 3                    \\
2                          & 1                          & 3                          & \multicolumn{1}{c|}{6}     & Diff 3                   
\end{tabular}
\end{table}
